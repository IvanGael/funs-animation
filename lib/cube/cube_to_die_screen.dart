...
class CubeToDieScreen extends StatelessWidget {
  const CubeToDieScreen({super.key});
...
class CubeToDieWidget extends StatefulWidget {
  const CubeToDieWidget({super.key});
...
class _CubeToDieWidgetState extends State<CubeToDieWidget> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: CustomPaint(
        painter: CubeToDiePainter(_animationProgress),
...
class CubeToDiePainter extends CustomPainter {
  ...
  CubeToDiePainter(this.animationProgress);
